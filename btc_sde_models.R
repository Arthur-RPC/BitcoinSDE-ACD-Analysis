...
ggsave("Preço_tempo_ing.pdf", width = 158, height = 93, units = "mm")
...
ggplot(df_long, aes(Date)) +
  ...
  labs(x = "Date", y = "Price (thousands US$)", color = "") +
  theme_bw() +
  theme(
...
ggsave("Observado_vs_Predito_ing.pdf", width = 170, height = 93, units = "mm")
...
ggsave("Boxplot_Residuos_ing.pdf", width = 158, height = 93, units = "mm")
...
ggsave("ACF_ing.pdf", width = 158, height = 93, units = "mm")
...
ggsave("Dispersao_res_ing.pdf", width = 158, height = 93, units = "mm")
...
ggsave("Residuos_Padronizados_ing.pdf", width = 158, height = 93, units = "mm")
